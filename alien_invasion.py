...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        collisions = pygame.sprite.groupcollide(self.bullets, self.aliens, True, True) # Change the first boolean to false for creating a laser beam.
    ...
    def _check_fleet_edges(self):
        ...
        for alien in self.aliens.sprites():
            if alien.check_edges():                 # Checking if any alien touches the edge of the screen.
                self._change_fleet_direction()      # Changes the direction if a single alien touches the screen to either 1 or -1.
                break
